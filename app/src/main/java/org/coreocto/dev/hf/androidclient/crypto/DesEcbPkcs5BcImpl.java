...
public class DesEcbPkcs5BcImpl implements IByteCipher {
    private static final String CIPHER_AES = "AES";
    private static final String CIPHER_TRANSFORM = "DES/ECB/PKCS5Padding";

    private byte[] key = null;
    private byte[] iv = null;

    public DesEcbPkcs5BcImpl(byte[] key, byte[] iv) {
        this.key = key;
        this.iv = iv;
    }

    public DesEcbPkcs5BcImpl(){
