...
public class DesCbcPkcs5BcImpl implements IByteCipher {
    private static final String CIPHER_AES = "AES";
    private static final String CIPHER_TRANSFORM = "DES/CBC/PKCS5Padding";

    private byte[] key = null;
    private byte[] iv = null;

    public DesCbcPkcs5BcImpl(byte[] key, byte[] iv) {
        this.key = key;
        this.iv = iv;
    }

    public DesCbcPkcs5BcImpl(){
