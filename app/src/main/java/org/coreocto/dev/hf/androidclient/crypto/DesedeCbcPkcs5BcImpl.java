...
public class DesedeCbcPkcs5BcImpl implements IByteCipher {
    private static final String CIPHER_AES = "AES";
    private static final String CIPHER_TRANSFORM = "DESede/CBC/PKCS5Padding";

    private byte[] key = null;
    private byte[] iv = null;

    public DesedeCbcPkcs5BcImpl(byte[] key, byte[] iv) {
        this.key = key;
        this.iv = iv;
    }

    public DesedeCbcPkcs5BcImpl(){
