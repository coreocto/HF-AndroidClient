...
public class AesCbcNoPadBcImpl implements IByteCipher {
    private static final String CIPHER_AES = "AES";
    private static final String CIPHER_TRANSFORM = "AES/CBC/NoPadding";

    private byte[] key = null;
    private byte[] iv = null;

    public AesCbcNoPadBcImpl(byte[] key, byte[] iv) {
        this.key = key;
        this.iv = iv;
    }

    public AesCbcNoPadBcImpl(){
