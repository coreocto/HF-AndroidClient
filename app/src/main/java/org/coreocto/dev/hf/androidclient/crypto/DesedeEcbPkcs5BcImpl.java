...
public class DesedeEcbPkcs5BcImpl implements IByteCipher {
    private static final String CIPHER_AES = "AES";
    private static final String CIPHER_TRANSFORM = "DESede/ECB/PKCS5Padding";

    private byte[] key = null;
    private byte[] iv = null;

    public DesedeEcbPkcs5BcImpl(byte[] key, byte[] iv) {
        this.key = key;
        this.iv = iv;
    }

    public DesedeEcbPkcs5BcImpl(){
